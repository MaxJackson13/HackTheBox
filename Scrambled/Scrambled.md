...
I notice the MSSQLSvc user has the `SeImpersonatePrivilege` which is typical of a lot of service accounts and is a very dangerous (useful!) privilege to have for privilege escalation.
